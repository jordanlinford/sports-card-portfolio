...
- **Card Image Scanner**: Gemini 2.5 Flash vision-based card identification from photos. Automatically identifies player, year, set, variation, grade, and grading company from card images, then fetches real eBay comps for pricing. Daily limits: 10 scans/day for free users, 100 scans/day for Pro users. Located in Quick Card Check under "Scan Photo" mode.
