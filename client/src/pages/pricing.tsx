...
export default function PricingPage() {
  ...
  useEffect(() => {
    ...
    document.title = "Pricing — Free vs Pro | HobbyAlpha";
    ...
    const description =
      "Compare HobbyAlpha Free and Pro plans. Pro is $12/month and unlocks batch analysis, the Card Advisor, growth projections, and the full investor toolkit.";

    const metaDesc = setMeta('meta[name="description"]', "name", "description", description);
    const ogTitle = setMeta('meta[property="og:title"]', "property", "og:title", "HobbyAlpha Pricing");
